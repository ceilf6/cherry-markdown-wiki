所有的配置基本都在`/packages/cherry-markdown/src/Cherry.config.js`[代码文件](https://github.com/Tencent/cherry-markdown/blob/dev/packages/cherry-markdown/src/Cherry.config.js)里进行了标注，具体如下：
```javascript
/**
